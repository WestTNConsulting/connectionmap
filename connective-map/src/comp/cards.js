        ...
        {profileData.map((profile) => (
          ...
          <div className="cta">
            <div className="cta-btn">
             {/* LinkedIn Icon linked to the respective LinkedIn profile */}
                <a  href={getLinkedInUrl(profile.Name)} className="cta-btn-icon" 
                            target="_blank" rel="noopener noreferrer">
                  <img src={Externallink.socialMediaIcons["LinkedIn"]}// LinkedIn icon URL from Externallink
                   alt="" width="30" height="30"/>
                </a>
            {/* Contact information (email and phone) */}
              <a href={`mailto:${profile.Email}`} className="cta-btn-icon">
              ...
              <a href={`tel:${profile.Phone}`} className="cta-btn-icon">
